...
Wayne found this here: https://android.googlesource.com/platform/system/core/+/master/libcutils/hashmap.c#4
 ...
 */
void hashmapFree(Hashmap* map, bool freeKeys, bool freeValues);
